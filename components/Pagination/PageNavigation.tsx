            ...
            <div className="mobile:w-full tablet:w-[48%]">
				{nextPost && (
					<Link
                        ...
                        className="flex dark:text-indigo-200 no-underline items-center space-x-4 group bg-gray-100/50 dark:bg-slate-900/50 pl-0 pr-4 py-2">
            ...
            <div className="mobile:w-full mobile:mb-9 tablet:mb-0 tablet:w-[48%] justify-end">
				{prevPost && (
					<Link
                        ...
                        className="flex dark:text-indigo-200 no-underline items-center space-x-4 group bg-gray-100/50 dark:bg-slate-900/50 pl-4 py-2">
